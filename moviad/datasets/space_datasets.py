...
if __name__ == "__main__":
    ...
    mars_mean, mars_std = compute_mean_std(MarsDataset(root_dir="/home/fgenilotti/Downloads/vad-space/mars/3732485", split="train", transform=None))
    ...
    lunar_dataset = LunarDataset(root_dir="/home/fgenilotti/Downloads/vad-space/lunar/7041842", split="test", transform=None, test_positive_ratio=0.05)
    mars_dataset = MarsDataset(root_dir="/home/fgenilotti/Downloads/vad-space/mars/3732485", split="train", transform=mars_transform)
